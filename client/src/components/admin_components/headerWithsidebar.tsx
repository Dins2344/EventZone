                  ...
                  <ul className="py-1" role="none">
                    ...
                    <li>
                      <button
                        ...
                        className="block w-full text-left pl-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white"
                        role="menuitem"
                      >
                        Sign out
                      </button>
