...
const adminRouter = () => {
  ...
  router.get(
    ...
    controller.deleteEventCategoryController
  );
  router.get(
    "/get-all-event-categories",
    controller.getEventCategoriesController
  );
  router.get(
    "/get-single-event-categories/:id",
    controller.getSingleEventCategoryController
  );
  ...
  router.get(
    "/delete-org-category/:id",
    controller.deleteOrgCategoryController
  );
  router.post("/edit-org-category", controller.editOrgCategoryController);
  router.get(
    "/get-single-org-category/:id",
    controller.getSingleOrgCategoryController
  );
  ...
  router.get(
    ...
    controller.getAdminMonthlyTicketSalesController
  );
  router.get(
    "/get-monthly-ticket-type-sales",
    controller.getAdminTicketTypeSoldController
  );
